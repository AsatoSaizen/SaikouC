package ani.saikouc.connections.anilist.api
...
class Query {
    ...
    data class Viewer(
        ...
        data class Data(
            @SerialName("Viewer")
            val user: ani.saikouc.connections.anilist.api.User?
        )
    }
    ...
    data class Media(
        ...
        data class Data(
            @SerialName("Media")
            val media: ani.saikouc.connections.anilist.api.Media?,
            @SerialName("Page")
            val page: ani.saikouc.connections.anilist.api.Page?
        )
    }
...
//    ){
//        data class Data(
//            val AiringSchedule: ani.saikouc.connections.anilist.api.AiringSchedule?
//        )
//    }
    ...
    data class Character(
        ...
        data class Data(
            ...
            val character: ani.saikouc.connections.anilist.api.Character?
        )
    }
    ...
    data class Studio(
        ...
        data class Data(
            @SerialName("Studio")
            val studio: ani.saikouc.connections.anilist.api.Studio?
        )
    }
...
//    ){
//        data class Data(
//            val MediaList: ani.saikouc.connections.anilist.api.MediaList?
//        )
//    }
    ...
    data class MediaListCollection(
        ...
        data class Data(
            ...
            val mediaListCollection: ani.saikouc.connections.anilist.api.MediaListCollection?
        )
    }
    ...
    data class CombinedMediaListResponse(
        ...
        @Serializable
        data class Data(
            @SerialName("current") val current: ani.saikouc.connections.anilist.api.MediaListCollection?,
            @SerialName("planned") val planned: ani.saikouc.connections.anilist.api.MediaListCollection?,
            @SerialName("repeating") val repeating: ani.saikouc.connections.anilist.api.MediaListCollection?,
        )
    }
    ...
    data class HomePageMedia(
        ...
        @Serializable
        data class Data(
            @SerialName("currentAnime") val currentAnime: ani.saikouc.connections.anilist.api.MediaListCollection?,
            @SerialName("repeatingAnime") val repeatingAnime: ani.saikouc.connections.anilist.api.MediaListCollection?,
            @SerialName("favoriteAnime") val favoriteAnime: ani.saikouc.connections.anilist.api.User?,
            @SerialName("plannedAnime") val plannedAnime: ani.saikouc.connections.anilist.api.MediaListCollection?,
            @SerialName("currentManga") val currentManga: ani.saikouc.connections.anilist.api.MediaListCollection?,
            @SerialName("repeatingManga") val repeatingManga: ani.saikouc.connections.anilist.api.MediaListCollection?,
            @SerialName("favoriteManga") val favoriteManga: ani.saikouc.connections.anilist.api.User?,
            @SerialName("plannedManga") val plannedManga: ani.saikouc.connections.anilist.api.MediaListCollection?,
            @SerialName("recommendationQuery") val recommendationQuery: ani.saikouc.connections.anilist.api.Page?,
            @SerialName("recommendationPlannedQueryAnime") val recommendationPlannedQueryAnime: ani.saikouc.connections.anilist.api.MediaListCollection?,
            @SerialName("recommendationPlannedQueryManga") val recommendationPlannedQueryManga: ani.saikouc.connections.anilist.api.MediaListCollection?,
    ...
    data class AnimeList(
        ...
        @Serializable
        data class Data(
            @SerialName("recentUpdates") val recentUpdates: ani.saikouc.connections.anilist.api.Page?,
            @SerialName("trendingMovies") val trendingMovies: ani.saikouc.connections.anilist.api.Page?,
            @SerialName("topRated") val topRated: ani.saikouc.connections.anilist.api.Page?,
            @SerialName("mostFav") val mostFav: ani.saikouc.connections.anilist.api.Page?,
        )
    }
    ...
    data class MangaList(
        ...
        @Serializable
        data class Data(
            @SerialName("trendingManga") val trendingManga: ani.saikouc.connections.anilist.api.Page?,
            @SerialName("trendingManhwa") val trendingManhwa: ani.saikouc.connections.anilist.api.Page?,
            @SerialName("trendingNovel") val trendingNovel: ani.saikouc.connections.anilist.api.Page?,
            @SerialName("topRated") val topRated: ani.saikouc.connections.anilist.api.Page?,
            @SerialName("mostFav") val mostFav: ani.saikouc.connections.anilist.api.Page?,
        )
    }
    ...
    data class FollowerPage(
        ...
        val followers: List<ani.saikouc.connections.anilist.api.User>?
    ) : java.io.Serializable

    @Serializable
    data class FollowingPage(
        @SerialName("following")
        val following: List<ani.saikouc.connections.anilist.api.User>?
    ) : java.io.Serializable
