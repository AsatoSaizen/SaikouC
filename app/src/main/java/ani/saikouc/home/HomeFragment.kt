...
import ani.saikouc.bottomBar
import ani.saikouc.connections.anilist.Anilist
import ani.saikouc.connections.anilist.AnilistHomeViewModel
import ani.saikouc.connections.anilist.getUserId
import ani.saikouc.currContext
import ani.saikouc.databinding.FragmentHomeBinding
import ani.saikouc.home.status.UserStatusAdapter
import ani.saikouc.loadImage
import ani.saikouc.media.Media
import ani.saikouc.media.MediaAdaptor
import ani.saikouc.media.MediaListViewActivity
import ani.saikouc.media.user.ListActivity
import ani.saikouc.navBarHeight
import ani.saikouc.profile.ProfileActivity
import ani.saikouc.setSafeOnClickListener
import ani.saikouc.setSlideIn
import ani.saikouc.setSlideUp
import ani.saikouc.settings.SettingsDialogFragment
import ani.saikouc.settings.saving.PrefManager
import ani.saikouc.settings.saving.PrefManager.asLiveBool
