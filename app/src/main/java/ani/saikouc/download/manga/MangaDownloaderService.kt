package ani.saikouc.download.manga
...
import ani.saikouc.media.manga.ImageData
import ani.saikouc.media.manga.MangaReadFragment.Companion.ACTION_DOWNLOAD_FAILED
import ani.saikouc.media.manga.MangaReadFragment.Companion.ACTION_DOWNLOAD_FINISHED
import ani.saikouc.media.manga.MangaReadFragment.Companion.ACTION_DOWNLOAD_PROGRESS
import ani.saikouc.media.manga.MangaReadFragment.Companion.ACTION_DOWNLOAD_STARTED
import ani.saikouc.media.manga.MangaReadFragment.Companion.EXTRA_CHAPTER_NUMBER
import ani.saikouc.snackString
import ani.saikouc.util.Logger
import ani.saikouc.util.NumberConverter.Companion.ofLength
