package ani.saikouc.widgets.statistics
...
import ani.saikouc.util.BitmapUtil.downloadImageAsBitmap
import ani.saikouc.widgets.WidgetSizeProvider
...
class ProfileStatsWidget : AppWidgetProvider() {
    ...
    companion object {
        ...
        fun getPrefsName(appWidgetId: Int): String {
            return "ani.saikouc.widgets.Statistics.${appWidgetId}"
        }
