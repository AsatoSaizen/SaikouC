...
class SettingsActivity : AppCompatActivity() {
    ...
    companion object {
        fun getDeviceInfo(): String {
            return """
                saikouc Version: ${BuildConfig.VERSION_NAME}
                Device: $BRAND $DEVICE
