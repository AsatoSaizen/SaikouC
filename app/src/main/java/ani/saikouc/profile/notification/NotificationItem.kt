...
import ani.saikouc.profile.activity.ActivityItemBuilder
import ani.saikouc.profile.notification.NotificationFragment.Companion.NotificationClickType
    ...
    private fun image(
        ...
        if (user) {
            ...
            if (commentNotification) {
                binding.notificationCoverUser.setImageResource(R.drawable.ic_saikouc_round)
