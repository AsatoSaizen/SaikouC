...
import ani.saikouc.addons.AddonDownloader.Companion.hasUpdate
...
class TorrentAddonManager(
    ...
    companion object {
        const val TORRENT_PACKAGE = "saikouc.torrentAddon"
        const val TORRENT_CLASS = "ani.saikouc.torrentAddon.TorrentAddon"
