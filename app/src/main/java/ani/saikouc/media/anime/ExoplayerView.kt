...
import ani.saikouc.brightnessConverter
import ani.saikouc.circularReveal
...
import ani.saikouc.databinding.ActivityExoplayerBinding
import ani.saikouc.defaultHeaders
import ani.saikouc.download.DownloadsManager.Companion.getSubDirectory
import ani.saikouc.download.video.Helper
import ani.saikouc.dp
import ani.saikouc.getCurrentBrightnessValue
import ani.saikouc.getLanguageCode
import ani.saikouc.hideSystemBars
...
import ani.saikouc.media.MediaType
import ani.saikouc.media.SubtitleDownloader
import ani.saikouc.okHttpClient
import ani.saikouc.others.AniSkip
import ani.saikouc.others.AniSkip.getType
import ani.saikouc.others.LanguageMapper
import ani.saikouc.others.ResettableTimer
import ani.saikouc.others.Xubtitle
import ani.saikouc.others.getSerialized
import ani.saikouc.parsers.AnimeSources
import ani.saikouc.parsers.HAnimeSources
import ani.saikouc.parsers.Subtitle
import ani.saikouc.parsers.SubtitleType
import ani.saikouc.parsers.Video
import ani.saikouc.parsers.VideoExtractor
import ani.saikouc.parsers.VideoType
import ani.saikouc.settings.PlayerSettingsActivity
            ...
            lifecycleScope.launch {
                ...
                val buttons = when (discordMode) {
                    ...
                    "saikouc" -> mutableListOf(
                        RPC.Link(getString(R.string.view_anime), media.shareLink ?: ""),
                        RPC.Link("Watch on Dantotsu", getString(R.string.saikouc))
                    )
