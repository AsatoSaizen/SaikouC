package ani.saikouc.media.manga.mangareader
...
import ani.saikouc.GesturesListener
import ani.saikouc.NoPaddingArrayAdapter
...
import ani.saikouc.connections.discord.Discord
import ani.saikouc.connections.discord.DiscordService
import ani.saikouc.connections.discord.DiscordServiceRunningSingleton
import ani.saikouc.connections.discord.RPC
import ani.saikouc.connections.updateProgress
import ani.saikouc.currContext
import ani.saikouc.databinding.ActivityMangaReaderBinding
import ani.saikouc.dp
import ani.saikouc.hideSystemBarsExtendView
...
import ani.saikouc.media.MediaNameAdapter
import ani.saikouc.media.MediaSingleton
import ani.saikouc.media.manga.MangaCache
import ani.saikouc.media.manga.MangaChapter
import ani.saikouc.others.ImageViewDialog
import ani.saikouc.parsers.HMangaSources
import ani.saikouc.parsers.MangaImage
import ani.saikouc.parsers.MangaSources
import ani.saikouc.px
import ani.saikouc.setSafeOnClickListener
import ani.saikouc.settings.CurrentReaderSettings
import ani.saikouc.settings.CurrentReaderSettings.Companion.applyWebtoon
import ani.saikouc.settings.CurrentReaderSettings.Directions.BOTTOM_TO_TOP
import ani.saikouc.settings.CurrentReaderSettings.Directions.LEFT_TO_RIGHT
import ani.saikouc.settings.CurrentReaderSettings.Directions.RIGHT_TO_LEFT
import ani.saikouc.settings.CurrentReaderSettings.Directions.TOP_TO_BOTTOM
import ani.saikouc.settings.CurrentReaderSettings.DualPageModes.Automatic
import ani.saikouc.settings.CurrentReaderSettings.DualPageModes.Force
import ani.saikouc.settings.CurrentReaderSettings.DualPageModes.No
import ani.saikouc.settings.CurrentReaderSettings.Layouts.CONTINUOUS_PAGED
import ani.saikouc.settings.CurrentReaderSettings.Layouts.PAGED
import ani.saikouc.settings.saving.PrefManager
import ani.saikouc.settings.saving.PrefName
import ani.saikouc.showSystemBarsRetractView
            ...
            if (chap != null) {
                ...
                if ((isOnline(context) && !offline) && Discord.token != null && !incognito && rpcenabled) {
                    lifecycleScope.launch {
                        val discordMode = PrefManager.getCustomVal("discord_mode", "saikouc")
                        val buttons = when (discordMode) {
                            "nothing" -> mutableListOf(
                                RPC.Link(getString(R.string.view_manga), media.shareLink ?: ""),
                            )

                            "saikouc" -> mutableListOf(
                                RPC.Link(getString(R.string.view_manga), media.shareLink ?: ""),
                                RPC.Link("Read on Dantotsu", getString(R.string.saikouc))
                            )
