...
import ani.saikouc.databinding.FragmentMediaSourceBinding
import ani.saikouc.download.DownloadedType
import ani.saikouc.download.DownloadsManager
import ani.saikouc.download.DownloadsManager.Companion.compareName
import ani.saikouc.download.manga.MangaDownloaderService
import ani.saikouc.download.manga.MangaServiceDataSingleton
...
import ani.saikouc.media.manga.mangareader.ChapterLoaderDialog
import ani.saikouc.navBarHeight
import ani.saikouc.notifications.subscription.SubscriptionHelper
import ani.saikouc.notifications.subscription.SubscriptionHelper.Companion.saveSubscription
import ani.saikouc.others.LanguageMapper
import ani.saikouc.parsers.DynamicMangaParser
import ani.saikouc.parsers.HMangaSources
import ani.saikouc.parsers.MangaParser
import ani.saikouc.parsers.MangaSources
import ani.saikouc.parsers.OfflineMangaParser
import ani.saikouc.setNavigationTheme
import ani.saikouc.settings.extensionprefs.MangaSourcePreferencesFragment
import ani.saikouc.settings.saving.PrefManager
import ani.saikouc.settings.saving.PrefName
import ani.saikouc.snackString
import ani.saikouc.util.StoragePermissions.Companion.accessAlertDialog
import ani.saikouc.util.StoragePermissions.Companion.hasDirAccess
...
open class MangaReadFragment : Fragment(), ScanlatorSelectionListener {
    ...
    companion object {
        const val ACTION_DOWNLOAD_STARTED = "ani.saikouc.ACTION_DOWNLOAD_STARTED"
        const val ACTION_DOWNLOAD_FINISHED = "ani.saikouc.ACTION_DOWNLOAD_FINISHED"
        const val ACTION_DOWNLOAD_FAILED = "ani.saikouc.ACTION_DOWNLOAD_FAILED"
        const val ACTION_DOWNLOAD_PROGRESS = "ani.saikouc.ACTION_DOWNLOAD_PROGRESS"
